#!/usr/bin/env python3
import os, sys, time, logging, spidev as SPI
sys.path.append(".")
...
try:
    ...
    '''
    Font1 = ImageFont.truetype("Font/Font01.ttf",45)
    Font2 = ImageFont.truetype("Font/Font01.ttf",45)
    Font3 = ImageFont.truetype("Font/Font02.ttf",32)

    draw.rectangle([(0,65),(140,100)],fill = "WHITE")
    draw.text((0, 5), 'Hello', fill = "BLACK",font=Font1)
    draw.rectangle([(0,115),(190,160)],fill = "RED")
    draw.text((5, 118), 'Lily', fill = "WHITE",font=Font2)
    draw.text((5, 160), 'Grassglen Place', fill = "GREEN",font=Font3)
    text= "Wesley Chapel"
